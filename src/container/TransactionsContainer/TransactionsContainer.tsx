...
import { formatTransactionsFromJson, Transactions } from '../../types/Transaction'
...
const TransactionsContainer = ({ hash }: Prop) => {
  ...
  const service = useGetService<Transactions>(
    ApiUrls.TRANSACTIONS_LIST,
    { hash },
    formatTransactionsFromJson,
  )
